    ...
    <nav className="bg-white border-b border-gray-200 shadow-sm sticky top-0 z-40">
      <div className="max-w-6xl mx-auto px-6 py-3 flex justify-between items-center">
        ...
        <div
          ...
          onClick={() => navigate('/')}
        >
          <div className="bg-green-600 text-white w-8 h-8 rounded-lg flex items-center justify-center font-bold text-sm shadow-sm">
            R
          </div>
          <span className="text-gray-800 font-bold text-lg tracking-tight">
          ...
          {user ? (
            <>
              ...
              {user.role === 'citizen' && (
                <button
                  onClick={() => navigate('/report')}
                  className="bg-green-600 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-green-700 transition flex items-center gap-1 shadow-sm"
                >
                ...
                {dropdownOpen && (
                  <div className="absolute right-0 mt-2 w-60 bg-white rounded-xl shadow-xl border border-gray-100 z-50 overflow-hidden">
                    ...
                    <div className="px-4 py-4 bg-gradient-to-r from-green-50 to-emerald-50 border-b border-gray-100">
                      <div className="flex items-center gap-3">
                        <div className="w-11 h-11 rounded-full bg-green-600 text-white flex items-center justify-center font-bold text-lg shadow">
                          {user.name.charAt(0).toUpperCase()}
                        </div>
                        <div>
                          <p className="font-semibold text-gray-800">
                          ...
                          <div className="flex items-center gap-1.5 mt-0.5">
                            <span className={`w-2 h-2 rounded-full ${roleConfig[user.role]?.color}`}></span>
                            <span className={`text-xs px-2 py-0.5 rounded-full capitalize font-medium ${roleConfig[user.role]?.bgColor}`}>
                              {user.role}
                            </span>
                          </div>
                        </div>
                    ...
                    <div className="py-2">
                      <button
                        ...
                        className="w-full text-left px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50 flex items-center gap-3 transition"
                      >
                        <span className="w-8 h-8 bg-green-50 rounded-lg flex items-center justify-center text-base">
                          📊
                        </span>
                        <div>
                          <p className="font-medium">Dashboard</p>
            ...
            <>
              <button
                onClick={() => navigate('/login')}
                className="text-gray-600 text-sm font-medium hover:text-green-600 transition px-3 py-2 rounded-lg hover:bg-gray-50"
              >
                Login
              </button>
              <button
